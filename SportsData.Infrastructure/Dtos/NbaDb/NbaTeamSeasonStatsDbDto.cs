...
{
    public class NbaTeamSeasonStatsDbDto
    {
        public NbaTeamSeasonStatsDbDto(int pointsFor, int pointsAgainst, int fastBreakPoints, int pointsInPaint, int biggestLead, int secondChancePoints, int pointsOffTurnovers, int longestRun, int fGM, int fGA, double fGP, int fTM, int fTA, double fTP, int tPM, int tPA, double tPP, int offReb, int defReb, int totReb, int assists
